                ...
                (
                    <tbody>
                        <tr>
                            ...
                            <td data-reservation-id-status={reservation.id}>{reservation.status == null ? 'booked' : reservation.status}</td>
                            {reservation.status === 'seated' ? ' ' : <td><a className="btn btn-secondary" href={`/reservations/${reservation_id}/seat`}>Seat</a></td>}
